...
const TopNav = () => {
    ...
    return (
        <nav className='bg-indigo-700 md:mb-7 mb-2 text-white flex items-center justify-between md:justify-start md:space-x-20 px-4 md:px-10 py-5 shadow-md'>
            <span className='hover:bg-violet-600 hover:cursor-pointer active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300' onClick={() => navigate('/accounts')}><AccountBalanceIcon>Accounts</AccountBalanceIcon></span>
