...
const AddModal = ({ ctaText, heading, paragraph, form, buttonIcon, ctaStyle='bg-violet-500' }: { ctaText: string, heading: string, paragraph: string, form: any, buttonIcon: any, ctaStyle?: string}) => {
    ...
    return (
        <>
            <button className={`${ctaStyle} hover:bg-blue-600 text-white font-bold py-2 px-4 rounded`} onClick={handleOpen}>
                {buttonIcon}{ctaText}
            </button>
            <Modal
                open={open}
